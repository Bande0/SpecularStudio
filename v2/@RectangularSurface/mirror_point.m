function [P_m, P_int] = mirror_point(obj, P)
% mirrors the point P wrt. the infinite plane defined by the
% RectangularSurface object
%
...
% infinite plane defined by the RectangularSurface object intersect
%
