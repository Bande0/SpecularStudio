...
% walls(i_wall).points = [[0,-1,1];...               
%                         [3,-1,2];...
%                         [3,4,3];...     
%                         [0,4,2];...
%                         ];
% walls(i_wall).idx = i_wall;
% walls(i_wall).points = [[0,0,0];...               
%                         [0,3,1];...
%                         [2,3,2];...     
%                         [2,0,1];...
%                         ];
...
for i = 1:length(walls)
    [P_m(i,:), P_int(i,:)] = mirror_point(P, walls(i));
end
